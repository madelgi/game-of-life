// 
// This is a VERY rudimentary way to handle barriers.
// This implementation is based on a version of barrier 
// I found online, but I have significantly simplified 
// that version. 
// 
#include <pthread.h>
#include "mybarrier.h"
